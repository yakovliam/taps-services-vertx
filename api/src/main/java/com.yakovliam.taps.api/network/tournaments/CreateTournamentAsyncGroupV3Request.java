...
public class CreateTournamentAsyncGroupV3Request extends TriumphRequest {
   ...
   * @param body the body
   */
  public CreateTournamentAsyncGroupV3Request(String gameId,
                                             CreateTournamentAsyncGroupV3RequestBody body,
                                             Device device, Identity identity) {
    super(RequestMethod.POST, "tournaments/async_group/v3/", body, device);
    this.gameId = gameId;
