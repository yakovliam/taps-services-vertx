...
public class ReportIntermediateScoreRequest extends TriumphRequest {
   ...
   * @param body the body
   */
  public ReportIntermediateScoreRequest(String gameId, ReportIntermediateScoreRequestBody body,
                                        Device device, Identity identity) {
    super(RequestMethod.POST, "tournaments/async_group/v3/report_intermediate_score", body, device);
    this.gameId = gameId;
